...
- Motto: full-bleed parallax photo backdrop (`parallax-background-1920.jpg`, web-sized 1600px/293KB generated from the 4160px original via PIL) with ±12% y drift; flat scrim removed — photo fully visible, with a dark-mode-only gradient band behind the text (measured mid-tone image: light-mode contrast passes unassisted); static when reduced motion; quote reveal unchanged.
